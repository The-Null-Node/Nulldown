...
/** Browser implementation of `DropCrypto` backed by the passkey vault. */
export class BrowserDropCrypto implements DropCrypto {
  ...
  async seal(
    ...
    let providerEncryption: { key: CryptoKey; kid: string } | null | undefined;
