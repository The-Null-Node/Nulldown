...
/** HTTP error wrapper emitted by remote drop-provider storage. */
...
/** Returns true when a value is a remote drop-provider HTTP error. */
...
/** Converts a failed fetch response into a typed drop-provider HTTP error. */
