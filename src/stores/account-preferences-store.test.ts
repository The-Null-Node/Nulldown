...
jest.unstable_mockModule("../lib/auth/account-preferences-client", () => ({
...
jest.unstable_mockModule("./drop-store", () => ({
...
const { useAccountPreferencesStore } = await import("./account-preferences-store");
